...
export const revisionSubmittedTemplate = (data: {
  ...
  const html = `
    ...
    <p style="margin: 0 0 24px 0; color: #334155; font-size: 15px; line-height: 1.6;">
      <strong>${data.studentName}</strong> has uploaded a consolidated revised document version addressing the corrections requested in the prior review cycle.
    </p>

    <!-- Version Control Metadata Callout Box (Table-based) -->
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 0 0 24px 0; border-collapse: collapse;">
      <tr>
        ...
        ">
          ...
          ${
            data.changeNote
              ? `<div style="margin-top: 12px; padding: 12px; background-color: #ffffff; border: 1px solid #e2e8f0;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 32px;">
      <tr>
        <td align="center" style="background-color: #3aa6ee;">
          <a href="${data.dashboardUrl}/supervisor/projects" target="_blank" rel="noopener noreferrer"
            style="
    ...
    <p style="
      ...
      line-height: 1.5;
    ">
      You can evaluate this revision, inspect historical version tracking logs, and manage approval status directly via your dashboard portal.
    </p>
  `;
